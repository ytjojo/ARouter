...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        // 将switch语句改为if-else语句，因为R.id.*可能不是编译时常量
        int viewId = v.getId();
        if (viewId == R.id.openLog) {
            ARouter.openLog();
        } else if (viewId == R.id.openDebug) {
            ARouter.openDebug();
        ...
        } else if (viewId == R.id.failNavmodule) {
            ARouter.getInstance().build("/test/xxx").navigation();
        } else if (viewId == R.id.failNavtest) {
        ...
        } else if (viewId == R.id.getMultiImplament) {
        ...
        } else if (viewId == R.id.staticMethodrouter) {
